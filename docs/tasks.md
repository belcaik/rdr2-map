...
| R02 | orchestrator: schemas/, shared/, fixtures/, root config, global docs | R01 | revisión | v1 machine contract, typed declarations, synthetic demo, additive migration strategy |
| R03 | research: rdr2_extractor/**, docs/source-discovery.md | R02 | pendiente | Normalize and download/resume real icons/photos, validate, report, Python tests |
| R04 | backend: backend/src/**, backend/tests/**, docs/migration.md | R02 | pendiente | Backup, migrate/repeat/value compare, unknown schema, upserts, local assets/API tests |
| R05 | orchestrator: frontend/src/** | R02 | pendiente | Cached symbols, safe detail/gallery, keyboard, mobile, errors |
| R06 | orchestrator: root/docs/config/CI/adapters | R02–R05 | en curso | Executable commands and one instruction source |
| R07 | QA: frontend/tests/**, frontend/playwright.config.ts; orchestrator integration | R03–R05 | pendiente | Offline E2E, real data visual checks, scale |
| R08 | QA independent review, orchestrator fixes/handoff | R06–R07 | pendiente | Findings resolved or explicit external limitations |
